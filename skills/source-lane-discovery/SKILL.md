# source-lane-discovery

## Purpose
Run a source lane against expected actor or community slots, normalize candidate surfaces, and preserve provenance without auto-verifying candidates.
