...
## Purpose
Deterministically inspect the local data-notes-2019.xlsx workbook, derive machine-readable municipality reference seeds, and record provenance without treating the workbook as authoritative current truth.
