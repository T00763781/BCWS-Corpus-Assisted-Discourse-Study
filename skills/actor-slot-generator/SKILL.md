# actor-slot-generator

## Purpose
Expand baseline municipality seeds plus actor-type slotting rules into expected actor stubs without inventing live accounts or verified entities.
